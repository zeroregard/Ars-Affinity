...
import com.github.ars_affinity.potion.LightningDashCooldownEffect;
...
public class ModPotions {
    ...
    public static final DeferredHolder<MobEffect, LightningDashCooldownEffect> LIGHTNING_DASH_COOLDOWN_EFFECT = EFFECTS.register("lightning_dash_cooldown", LightningDashCooldownEffect::new);
