...
import com.github.ars_affinity.potion.ActiveAbilityCooldownEffect;
...
public class ModPotions {
    ...
    public static final DeferredHolder<MobEffect, ActiveAbilityCooldownEffect> ACTIVE_ABILITY_COOLDOWN_EFFECT = EFFECTS.register("active_ability_cooldown", ActiveAbilityCooldownEffect::new);
