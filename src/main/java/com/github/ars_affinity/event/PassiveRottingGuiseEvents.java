...
import net.minecraft.world.entity.monster.WitherBoss;
...
public class PassiveRottingGuiseEvents {
    ...
    public static void onLivingChangeTarget(LivingChangeTargetEvent event) {
        ...
        AffinityPerkHelper.applyActivePerk(player, AffinityPerkType.PASSIVE_ROTTING_GUISE, AffinityPerkHelper.SimplePerk.class, perk -> {
