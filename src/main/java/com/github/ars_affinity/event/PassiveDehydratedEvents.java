...
public class PassiveDehydratedEvents {
    ...
    public static void onManaRegenCalc(ManaRegenCalcEvent event) {
        ...
        // Check if player is in the Nether or on fire
        ...
        if (isInNether || isOnFire) {
            ...
            if (progress != null) {
                ...
                if (waterTier > 0) {
                    ...
                    AffinityPerkHelper.applyPerks(progress, waterTier, SpellSchools.ELEMENTAL_WATER, perk -> {
                        if (perk.perk == AffinityPerkType.PASSIVE_DEHYDRATED && perk instanceof AffinityPerk.AmountBasedPerk amountPerk) {
