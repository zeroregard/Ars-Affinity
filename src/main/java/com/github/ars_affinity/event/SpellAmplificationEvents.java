...
public class SpellAmplificationEvents {
    ...
    public static void onSpellCast(SpellCastEvent event) {
        ...
        if (progress != null) {
            // Check all schools for healing amplification perks
            AffinityPerkHelper.applyAllHighestTierPerks(progress, AffinityPerkType.PASSIVE_HEALING_AMPLIFICATION, perk -> {
